export const proofMetrics = [
  { value: '3 to 10 days', label: 'for most launch-ready delivery windows' },
  { value: '24/7', label: 'response coverage through automation flows' },
  { value: 'PK + global', label: 'client fit across local shops and SaaS teams' },
];
