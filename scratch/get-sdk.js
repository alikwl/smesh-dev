...
async function run() {
  const result = await callTool('get_sdk_reference', {});
  fs.writeFileSync('scratch/n8n-sdk-ref.json', JSON.stringify(result, null, 2));
  console.log("Written SDK reference to scratch/n8n-sdk-ref.json");
}
