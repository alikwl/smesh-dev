import{s as c,h as b,t as p,j as x}from"./supabase.DrEM_WOr.js";document.addEventListener("DOMContentLoaded",async()=>{const o=document.getElementById("portfolio-table-body");if(!o)return;const l=async()=>{o.innerHTML=`
